        ...
        <div className="my-4">
            ...
            <div className="carousel w-full h-60 md:h-96">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/MZ3rBd1/Pixel-7-Obsidian-1130.jpg" className="w-44 md:w-80 lg:ml-48" />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/RTZmhDk/Pixel-6-Sorta-Seafoam-800x800.png" className="w-44 md:w-80 lg:ml-48" />
                    <h1 className="mt-24 lg:mt-44 md:text-4xl pr-2 font-semibold">Buy now to get the offer!!!! <br /> Up to <span className="text-red-400">10%</span></h1>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/bvqdHVN/Google-Pixel-Watch-2.jpg" className="w-44 md:w-80 lg:ml-48" />
                    <h1 className="mt-24 lg:mt-44 md:text-4xl pr-2 font-semibold">Buy now to get the offer!!!! <br /> Up to <span className="text-red-400">10%</span></h1>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
